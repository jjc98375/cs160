...
Update the "at"vector to be at = eye + f_prime;
    */
    panLeft() {
        var f = sub(this.at.elements, this.eye.elements);
        var rotationMatrix = new Matrix4();
        rotationMatrix.setRotate(1, this.GlobalUpVector[0], this.GlobalUpVector[1], this.GlobalUpVector[2]);
        var f_prime = rotationMatrix.multiplyVector3(f);
        this.at.elements = add(this.eye.elements, f_prime);
        this.vectorUpdate(); 
    }
